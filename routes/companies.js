...
// send all filters as query key-value pairs
// minEmployees, maxEmployees, and/or name
...
router.patch("/:handle", adminOnly, async function (req, res, next) {
  try {
...
router.delete("/:handle", adminOnly, async function (req, res, next) {
  try {
